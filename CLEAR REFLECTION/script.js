...
for(let i=0;i<products.length;i++){
    main.innerHTML+=`<div class="col-7 col-lg-4 g-5">
    <a href="./singlepage.html?id=${products[i].id}" class="card-link">
    <div class="card" style="width: 18rem;">
  <img src=${products[i].image}class="card-img-top" alt="...">
  <div class="card-body">
    <h4 class="card-title"> ${products[i].name}</h4>
   <h5 class="card-price">RS, ${products[i].price}</h5>
<p class="card-text text-muted text-truncate">${products[i].description}</p>
...
function filters(material) {
      main.innerHTML = ''
      let filter = products.filter(function (items) {

        return items.type.toLowerCase().includes(material.toLowerCase())
      })
      for (let i = 0; i < filter.length; i++) {
        main.innerHTML +=`<div class="col-6 col-lg-3" id="card">
     ...
     function filters2(material2) {
      main.innerHTML = ''
      let filter2 = products.filter(function (items2) {

        return items2.category.toLowerCase().includes(material2.toLowerCase())
      })
      ...
      main.innerHTML = ''
      let filter3 = products.filter(function (items3) {
